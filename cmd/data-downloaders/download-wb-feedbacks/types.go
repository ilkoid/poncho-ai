...
//
// All types are 1:1 mapping from docs/09-communications.yaml API schema.
// No computed fields — only raw data from the API.
//
// Nested JSON objects (answer, productDetails, video) are flattened
// into prefixed fields for direct SQLite INSERT without transformation.
package main
...
type FeedbacksResponse struct {
	Data struct {
		...
		Feedbacks       []FeedbackFull `json:"feedbacks"`
	} `json:"data"`
...
// ============================================================================
// FeedbackFull — полный отзыв из API (39 полей)
//
// Схема: docs/09-communications.yaml → responseFeedback
// Вложенные объекты развёрнуты в плоские поля с префиксом.
// ============================================================================
...
// feedbackJSON — internal type for JSON unmarshal with nested objects.
...
// ============================================================================
// QuestionFull — полный вопрос из API (16 полей)
//
// Схема: docs/09-communications.yaml → /api/v1/questions response
// ============================================================================
...
// questionJSON — internal type for JSON unmarshal with nested objects.
