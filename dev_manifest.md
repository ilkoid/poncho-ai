...
Каждый инструмент должен иметь возможность мокирования зависимостей для юнит-тестов. Никаких прямых HTTP-вызовов без возможности абстрагирования.
...
## Заключение
Poncho AI - это архитектурно зрелый фреймворк с высокой степенью целостности. Код полностью соответствует декларируемым принципам из brief.md. Предложенные правила обеспечат сохранение архитектурной чистоты при дальнейшем развитии фреймворка.
