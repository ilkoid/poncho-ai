#!/bin/bash
# WB Full Data Refresh — simple dual-backend (SQLite + PostgreSQL)
#
...
#
# Два прогона: сначала SQLite, потом PostgreSQL.
...
PG_ELAPSED=$(( SECONDS - PASS2_START ))
