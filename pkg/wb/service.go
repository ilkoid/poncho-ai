...
// CampaignFullstatsResponse represents detailed campaign statistics.
type CampaignFullstatsResponse struct {
	AdvertID     int                         `json:"advertId"`
	Atbs         int                         `json:"atbs"`       // Returns
	Canceled     int                         `json:"canceled"`   // Cancellations
	Clicks       int                         `json:"clicks"`
	CPC          float64                     `json:"cpc"`
	CR           float64                     `json:"cr"`         // Conversion rate
	CTR          float64                     `json:"ctr"`
	Orders       int                         `json:"orders"`
	Shks         int                         `json:"shks"`       // Buyouts
	Sum          float64                     `json:"sum"`        // Ad spend
	SumPrice     float64                     `json:"sum_price"`  // Order sum
	Views        int                         `json:"views"`
	Days         []CampaignFullstatsDay      `json:"days"`
}

// CampaignFullstatsDay represents statistics for a single day.
...
// CampaignFullstatsApp represents statistics per app type (site, Android, iOS).
type CampaignFullstatsApp struct {
	AppType  int     `json:"appType"` // 1=site, 32=Android, 64=iOS
	Atbs     int     `json:"atbs"`
	Canceled int     `json:"canceled"`
	Clicks   int     `json:"clicks"`
	CPC      float64 `json:"cpc"`
...
// CampaignFullstatsNm represents statistics per product in campaign.
