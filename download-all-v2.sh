...
#
# v2 downloaders (cards, prices, orders, opsales, sales, stocks, funnel, feedbacks) support
...
# v2 downloaders: orders ✅, opsales ✅, sales ✅
# v1 downloaders: region-sales (no PG adapter yet)
...
# v1 downloaders: promotion (no PG adapter yet)
...
echo ""
echo "  v2 downloaders (PG-ready): cards, prices, feedbacks, orders, opsales, sales, stocks, funnel"
echo "  v1 downloaders (SQLite):   1c-data, 1c-rests, region-sales, stock-history, supplies, promotion, funnel-csv, funnel-agg, search-visibility"
echo "==========================================="
